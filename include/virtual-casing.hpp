...
template <class Real> class VirtualCasing {
  ...
  public:
     ...
     */
    void Setup(const sctl::Integer digits, const sctl::Integer NFP, const sctl::Long Nt, const sctl::Long Np, const std::vector<Real>& X, const sctl::Long src_Nt, const sctl::Long src_Np, const sctl::Long trg_Nt, const sctl::Long trg_Np);
...
template <class Real> class VirtualCasingTestData {
  ...
  public:
     ...
     */
    static std::vector<Real> SurfaceCoordinates(const sctl::Integer NFP, const sctl::Long Nt, const sctl::Long Np, const biest::SurfType surf_type = biest::SurfType::AxisymNarrow);
     ...
     */
    static std::tuple<std::vector<Real>, std::vector<Real>> BFieldData(const sctl::Integer NFP, const sctl::Long Nt, const sctl::Long Np, const std::vector<Real>& X, const sctl::Long trg_Nt, const sctl::Long trg_Np);
};
